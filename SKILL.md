...
version: "1.0.0"
license: MIT
tools: [Bash, Grep, Read, Write, Glob]
metadata:
  author: danny
  domain: project-setup
  triggers: "MSA setup, CLAUDE.md generator, microservice, monorepo, context optimization, service architecture"
  role: generator
  scope: project
  output-format: files
  related-skills: "coding-standards, backend-patterns, frontend-patterns, claude-md-improver"
---
